...
func (c *userClient) CreateUser(ctx context.Context, in *UserCreateRequest, opts ...grpc.CallOption) (*UserCreateReply, error) {
	...
	err := c.cc.Invoke(ctx, "/above.account_service.User/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/above.account_service.User/CreateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "above_account_service/user.proto",
}
